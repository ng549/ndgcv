...
export function buildProcess(e,d,img){
 ...
 for(const [name,file] of Object.entries({'Factory':'factory.svg','Replit':'replit.svg','Plugsky':'plugsky.svg','OpenRouter':'openrouter.svg','Supabase':'supabase.svg','Vercel':'vercel.svg','Slack':'slack.png','Stripe':'stripe.svg'}))logos.set(name,'ndgcv/assets/ai-portfolio/tool-logos/'+file);
