...
export function editorial(html,d,e,img){
 ...
 for(const [id,name] of Object.entries(bg)){
  html=html.replace(new RegExp(`(<section[^>]*id="${id}"[^>]*>)`),`$1<div class="section-art" aria-hidden="true"><img src="illustrations/${name}${id==='about'?'-v4':'-v3'}.webp" alt="" loading="lazy" data-parallax="0.16"></div>`);
 }
