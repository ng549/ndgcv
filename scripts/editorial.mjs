...
export function editorial(html,d,e,img){
 ...
 const bg={about:'about-biography',opportunity:'opportunity',experience:'experience',build:'build',value:'value','product-journey':'product','software-work':'systems',contact:'contact'};
