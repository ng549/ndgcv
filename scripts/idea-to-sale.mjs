...
function productImage(e,id,brands,note='') {
  ...
  return `<details class="idea-product-group"><summary><h4>${e(brands)}</h4><span class="product-card-toggle" aria-hidden="true"></span></summary><a class="idea-image" href="assets/idea-to-sale/${id}-private-label.png" target="_blank" rel="noopener" aria-label="Open ${e(brands)} sketch at full size"><img src="assets/idea-to-sale/${id}-private-label.png" alt="${e(alt)}" width="1536" height="1024" loading="lazy" decoding="async"></a></details>`;
}
