...
<input id="phase" placeholder="Phase"><button id="runPhase" disabled${gPhase.reason ? ' title="' + escapeHtml(gPhase.reason) + '"' : ""}>RUN PHASE</button>
</div>
